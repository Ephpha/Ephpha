      ...
      <div className="max-w-2xl mx-auto px-4 text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <input
            ...
            className="w-full px-5 py-4 rounded-2xl border border-stone-200 text-stone-800 text-base shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-400"
          ...
          <button
            type="submit"
            disabled={isAnalyzing}
            className="w-full bg-amber-400 hover:bg-amber-500 text-stone-900 font-semibold py-4 rounded-2xl text-base transition-colors disabled:opacity-60"
          >
